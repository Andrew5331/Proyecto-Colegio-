...
public class Notas extends JFrame {
    public Notas() {
        ...
        lblNotas.setFont(new Font("Arial", Font.BOLD, 14)); // resaltada
        lblAsistencias.setFont(new Font("Arial", Font.PLAIN, 14));
        ...
        // Tabla de notas (centrada con margen lateral)
        String[] columnas = {"Estudiante", "Nota 1", "Nota 2", "Nota 3", "Examen", "Promedio", "Estado"};
        Object[][] datos = {
                {"Rafael Diaz", 3.5, 4.0, 5.0, 2.1, 3.65, "Aprobado"},
                {"Edgar Po", 3.0, 3.2, 2.8, 2.0, 2.75, "Desaprobado"},
                {"Ana Martinez", 4.5, 5.0, 4.7, 4.2, 4.60, "Aprobado"},
                {"Julian Neisa", 4.0, 4.2, 4.1, 4.0, 4.08, "Aprobado"},
                {"Camilo Fajardo", 1.8, 1.0, 2.1, 1.2, 1.53, "Desaprobado"},
                {"Juan Campo", 5.0, 5.0, 5.0, 5.0, 5.00, "Aprobado"},
        };
        ...
        // margen lateral mayor para que la tabla se vea centrada y con separación
        scrollTabla.setBorder(BorderFactory.createEmptyBorder(10, 80, 10, 80));
        panelCentral.add(scrollTabla, BorderLayout.CENTER);

        // Panel de botones abajo (AHORA: Descargar PDF primero, luego Guardar cambios)
        ...
        // Botones blancos estilo captura (borde gris clarito)
        JButton[] botones = {btnPDF, btnGuardar};
        ...
        // Añadimos en el orden solicitado: PDF primero
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new Notas());
    }
}
